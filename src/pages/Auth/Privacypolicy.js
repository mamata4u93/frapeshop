                ...
                <div className="mobile-header-wrapper-inner">
                    ...
                    <div className="mobile-header-content-area">
                        <div className="mobile-search search-style-3 mobile-header-border">
                            <form action="page-privacy-policy.html#">
                                ...
                                <ul className="mobile-menu font-heading">
                                    ...
                                    <li className="menu-item-has-children">
                                        ...
                                        <ul className="dropdown">
                                            ...
                                            <li className="menu-item-has-children">
                                                <a href="page-privacy-policy.html#">Single Product</a>
                                                <ul className="dropdown">
                                            ...
                                            <li className="menu-item-has-children">
                                                <a href="page-privacy-policy.html#">Shop Invoice</a>
                                                <ul className="dropdown">
                                    ...
                                    <li className="menu-item-has-children">
                                        <a href="page-privacy-policy.html#">Vendors</a>
                                        <ul className="dropdown">
                                    ...
                                    <li className="menu-item-has-children">
                                        <a href="page-privacy-policy.html#">Mega menu</a>
                                        <ul className="dropdown">
                                            <li className="menu-item-has-children">
                                                <a href="page-privacy-policy.html#">Women's Fashion</a>
                                                <ul className="dropdown">
                                            ...
                                            <li className="menu-item-has-children">
                                                <a href="page-privacy-policy.html#">Men's Fashion</a>
                                                <ul className="dropdown">
                                            ...
                                            <li className="menu-item-has-children">
                                                <a href="page-privacy-policy.html#">Technology</a>
                                                <ul className="dropdown">
                                    ...
                                    <li className="menu-item-has-children">
                                        ...
                                        <ul className="dropdown">
                                            ...
                                            <li className="menu-item-has-children">
                                                <a href="page-privacy-policy.html#">Single Product Layout</a>
                                                <ul className="dropdown">
                                    ...
                                    <li className="menu-item-has-children">
                                        <a href="page-privacy-policy.html#">Pages</a>
                                        <ul className="dropdown">
                                    ...
                                    <li className="menu-item-has-children">
                                        <a href="page-privacy-policy.html#">Language</a>
                                        <ul className="dropdown">
                                            <li><a href="page-privacy-policy.html#">English</a></li>
                                            <li><a href="page-privacy-policy.html#">French</a></li>
                                            <li><a href="page-privacy-policy.html#">German</a></li>
                                            <li><a href="page-privacy-policy.html#">Spanish</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </nav>
                        ...
                        <div className="mobile-header-info-wrap">
                            ...
                            <div className="single-mobile-header-info">
                                <a href="page-privacy-policy.html#"><i className="fi-rs-headphones"></i>(+01) - 2345 - 6789 </a>
                            </div>
                        </div>
                        <div className="mobile-social-icon mb-50">
                            <h6 className="mb-15">Follow Us</h6>
                            <a href="page-privacy-policy.html#"><img src="assets/imgs/theme/icons/icon-facebook-white.svg" alt="" /></a>
                            <a href="page-privacy-policy.html#"><img src="assets/imgs/theme/icons/icon-twitter-white.svg" alt="" /></a>
                            <a href="page-privacy-policy.html#"><img src="assets/imgs/theme/icons/icon-instagram-white.svg" alt="" /></a>
                            <a href="page-privacy-policy.html#"><img src="assets/imgs/theme/icons/icon-pinterest-white.svg" alt="" /></a>
                            <a href="page-privacy-policy.html#"><img src="assets/imgs/theme/icons/icon-youtube-white.svg" alt="" /></a>
                        </div>
                                        ...
                                        <div className="single-page pr-30 mb-lg-0 mb-sm-5">
                                            <div className="single-header style-2">
                                                ...
                                                <div className="entry-meta meta-1 meta-3 font-xs mt-15 mb-15">
                                                    <span className="post-by">By <a href="page-privacy-policy.html#">Jonh</a></span>
                                            ...
                                            <div className="single-content mb-50">
                                                ...
                                                <ol start="25">
                                                    <li>If you have any questions about our privacy practices or the way in which we have been managing your personal information, please contact our privacy champion in writing at PO Box 16122 Collins Street West Victoria 8007 Australia or <a href="../../../cdn-cgi/l/email-protection#0373716a7562607a2d606b626e736a6c6d43426f6a576b666e66702d606c6e"><span className="__cf_email__" data-cfemail="7f0f0d16091e1c06511c171e120f1610113f3e13162b171a121a0c511c1012">[email&#160;protected]</span></a>.</li>
