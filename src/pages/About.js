...
import about_1 from "../assets/imgs/page/about_1.png";
import about_2 from "../assets/imgs/page/about_2.png";
import about_3 from "../assets/imgs/page/about_3.png";
import about_4 from "../assets/imgs/page/about_4.png";
import about_5 from "../assets/imgs/page/about_5.png";
import about_6 from "../assets/imgs/page/about_6.png";
import about_8 from "../assets/imgs/page/about_8.png";
...
import icon_facebook_brand from "../assets/imgs/theme/icons/icon_facebook_brand.svg";
import icon_instagram_brand from "../assets/imgs/theme/icons/icon_instagram_brand.svg";
import icon_twitter_brand from "../assets/imgs/theme/icons/icon_twitter_brand.svg";
import icon_youtube_brand from "../assets/imgs/theme/icons/icon_youtube_brand.svg";
                            ...
                            <div className="col-xl-10 col-lg-12 m-auto">
                                <section className="row align-items-center mb-50">
                                    <div className="col-lg-6">
                                        <img src={about_1} alt="" className="border-radius-15 mb-md-3 mb-lg-0 mb-sm-4" />
                                    </div>
                                    <div className="col-lg-6">
                                        <div className="pl-25">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-4 col-md-6 mb-24">
                                            <div className="featured-card">
                                                ...
                                                <a href="page-about.html#">Read more</a>
                                            </div>
                                        </div>
                                        <div className="col-lg-4 col-md-6 mb-24">
                                            <div className="featured-card">
                                ...
                                <section className="row align-items-center mb-50">
                                    <div className="row mb-50 align-items-center">
                                        <div className="col-lg-7 pr-30">
                                            <img src={about_5} alt="" className="mb-md-3 mb-lg-0 mb-sm-4" />
                                        </div>
                                ...
                                <section className="mb-50">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-4 mb-lg-0 mb-md-5 mb-sm-5">
                                            ...
                                            <p className="mb-30">Proin ullamcorper pretium orci. Donec necscele risque leo. Nam massa dolor imperdiet neccon sequata congue idsem. Maecenas malesuada faucibus finibus.</p>
                                            <a href="page-about.html#" className="btn">View All Members</a>
                                        </div>
                                                    ...
                                                    <div className="team-card">
                                                        ...
                                                        <div className="content text-center">
                                                            ...
                                                            <div className="social-network mt-20">
                                                                <a href="page-about.html#"><img src={icon_facebook_brand} alt="" /></a>
                                                                <a href="page-about.html#"><img src={icon_instagram_brand} alt="" /></a>
                                                                <a href="page-about.html#"><img src={icon_twitter_brand} alt="" /></a>
                                                                <a href="page-about.html#"><img src={icon_youtube_brand} alt="" /></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
